...
const LEVELS = [
  { name: "verbose", icon: "icon-eye", label: "Verbose", scope: "definition.log.log-verbose" },
  { name: "info", icon: "icon-info", label: "Info", scope: "definition.log.log-info" },
  { name: "debug", icon: "icon-bug", label: "Debug", scope: "definition.log.log-debug" },
  { name: "warning", icon: "icon-alert", label: "Warning", scope: "definition.log.log-warning" },
  { name: "error", icon: "icon-stop", label: "Error", scope: "definition.log.log-error" },
];
...
class FilterView {
  ...
  addTooltips() {
    this.disposables.add(
      atom.tooltips.add(this.filterButton, { title: "Filter Log Lines" }),
      atom.tooltips.add(this.tailButton, { title: "Tail On File Changes" }),
      atom.tooltips.add(this.regexButton, { title: "Use Regex" }),
      atom.tooltips.add(this.caseSensitiveButton, { title: "Toggle case sensitivity" }),
    ...
    for (const level of LEVELS) {
      this.disposables.add(
        atom.tooltips.add(this.levelButtons.get(level.name), {
  ...
  handleEvents() {
    this.disposables.add(
      ...
      atom.config.onDidChange("log-filter.adjacentLines", () => this.refreshTextFilter()),
      atom.config.onDidChange("log-filter.foldPosition", () => this.filter.refold()),
      atom.config.onDidChange("log-filter.grammarScopes", () => this.updateLevelVisibility()),
    );
    ...
    if (this.textEditor.languageMode.fullyTokenized) {
